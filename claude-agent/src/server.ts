    ...
    options: {
      ...
      systemPrompt: {
        ...
        append: [
          ...
          "格式按输出扩展名定（.jpg→JPEG，压缩默认 80；.png→PNG）。默认出 .jpg——同图比 PNG 小 4~5 倍；只有要透明底才用 .png。",
          "可选: --size WxH(默认1024x1024，总像素须≥1024×640) --transparent --quality low|medium|high --format png|jpeg|webp --compression 0-100",
