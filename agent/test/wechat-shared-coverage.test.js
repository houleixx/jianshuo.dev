...
import { handleWechatPayRoute } from '../src/wechat-pay.js';
import { it } from 'vitest';
import { handleSubscriptionStatusRoute } from '../src/subscription-status.js';
it('preserves verified V3 paid coverage in the shared subscription guard', async () => {
const now=Date.now();
...
WECHAT_PAY_API_V2_KEY:'test-only',WECHAT_PAY_API_V3_KEY:'12345678901234567890123456789012',WECHAT_PAY_MCH_SERIAL_NO:'serial',
