...
<body>
  ...
  <main class="wrap" id="main">
    ...
    <section class="detail" id="billing" aria-labelledby="billing-title">
      ...
      <div class="body">
        <ol class="steps">
          <li><strong>首次开通：确认签约，再申请首扣</strong>在支持微信订阅的 Android 版 VoiceDrop 中进入「设置 → 算力」，选择微信支付订阅，并在微信中确认自动续费协议。首次签约成功后立即申请首期扣款；签约成功本身不代表付款成功。</li>
          <li><strong>每期续费：到期前三天申请</strong>后续扣款申请安排在当期到期日前第 3 个北京时间自然日凌晨 02:00。微信发送扣费前通知，通常在申请后 24 小时执行扣款，因此实际扣款可能早于当期到期日。</li>
          <li><strong>实际付款成功：发放当期算力</strong>以微信最终支付结果为准。首次或重新签约后 12 小时内申请的扣款可立即执行；其余按通知后 24 小时扣费模式处理。扣款未成功时不会发放对应算力。</li>
        </ol>
    ...
    <section class="detail" id="cancel" aria-labelledby="cancel-title">
      ...
      <div class="body">
        ...
        <h3>重新开通</h3>
        <p>重新开通需要再次在微信中确认签约。若旧一期权益尚未到期，新一期会衔接其到期时间；扣款仍按到期前三天的计划申请。若已过计划时间，重新签约后会立即申请扣款。旧订单结果未确认时，需先确认原支付结果后再开通。</p>
      </div>
    </section>
