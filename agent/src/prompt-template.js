...
export const DEFAULT_PROMPT_TEMPLATE = {
  ...
  items: [
    ...
    {
      // 「合影照片」：AE209A 树里的整组（6 个动作）收编为系统缺省
      //（2026-07-24 建硕拍板）。正文一字未动、顺序照抄原树；已铸的分享码继续各自有效。
      id: "sys_groupphoto", type: "group", label: "合影照片",
      children: [
        { id: "sys_gp_figure", type: "action", label: "收藏公仔合影", appliesTo: ["image"], kind: "image",
          prompt: "请基于我上传的合照进行编辑。保持所有人物的身份、五官特征、人数、站位、表情和身体姿势基本不变,只改变视觉风格和装饰元素。不要改变脸型,不要生成陌生人,不要增加或减少人物,不要让手指变形。画面适合发朋友圈/小红书,清晰、有趣、自然。风格如下：\n\n\n把合照中的朋友们变成一组可爱的收藏公仔展示图。每个人保持原本发型、服装颜色和表情特征,站位关系不变。背景像干净的玩具展示台,有柔和灯光和透明包装感,但不要出现真实品牌 logo。" },
        { id: "sys_gp_bokeh", type: "action", label: "植物和光斑合影", appliesTo: ["image"], kind: "image",
          prompt: "请基于我上传的合照进行编辑。保持所有人物的身份、五官特征、人数、站位、表情和身体姿势基本不变,只改变视觉风格和装饰元素。不要改变脸型,不要生成陌生人,不要增加或减少人物,不要让手指变形。画面适合发朋友圈/小红书,清晰、有趣、自然。风格：\n\n把这张合照转换成温柔日系动画电影风格。保留人物身份、发型、服装大体特征和站位,背景变得更柔和,有手绘质感、自然光、温暖色调。不要过度幼态化,不要改变脸部特征。" },
        { id: "sys_gp_qq", type: "action", label: "QQ弹弹的合影", appliesTo: ["image"], kind: "image",
          prompt: "请基于我上传的合照进行编辑。保持所有人物的身份、五官特征、人数、站位、表情和身体姿势基本不变,只改变视觉风格和装饰元素。不要改变脸型,不要生成陌生人,不要增加或减少人物,不要让手指变形。画面适合发朋友圈/小红书,清晰、有趣、自然。风格如下：\n\n\n把合照中的每个人做成可爱的 3D Q版角色,但要保留各自的发型、服装颜色、表情特点和站位关系。整体像旅行纪念公仔合影,人物比例可爱,材质柔和,背景简洁。" },
        { id: "sys_gp_anime", type: "action", label: "日系动画电影", appliesTo: ["image"], kind: "image",
          prompt: "把这张合照转换成温柔日系动画电影风格。保留人物身份感、发型、服装大体特征、人数、站位、表情和身体姿势；背景变得更柔和，有手绘质感、自然光、温暖色调和植物庭院氛围。不要过度幼态化，不要改变脸部特征，不要生成陌生人，不要增加或减少人物，不要出现真实品牌 logo、文字、水印或二维码。正文其他内容都不要动。" },
        { id: "sys_gp_cinema", type: "action", label: "电影感调色", appliesTo: ["image"], kind: "image",
          prompt: "只对这张合照做电影感调色和质感增强。保持人物、人数、背景、构图、服装和站位基本不变；加入柔和胶片颗粒、自然肤色、轻微高光、浅景深和电影海报般的色彩层次。不要改变五官、不要改服装、不要换背景、不要增加或减少人物，不要出现文字、logo、二维码或水印。正文其他内容都不要动。" },
        { id: "sys_gp_sticker", type: "action", label: "白边贴纸", appliesTo: ["image"], kind: "image",
          prompt: "把这张合照做成可爱白边贴纸风。保留每个人的真实身份感、人数、站位、表情和服装颜色；人物边缘加厚白色描边，再加一层很细的深色外描边；背景简化成干净浅色或轻微咖啡馆旅行元素，整体像一张朋友旅行贴纸或社交头像素材。不要改变人物数量，不要让脸变陌生，不要出现文字、真实品牌 logo、二维码或水印。正文其他内容都不要动。" },
      ],
    },
    {
